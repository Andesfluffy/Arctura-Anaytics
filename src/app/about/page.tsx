...
const stats = [
  {
    value: '150+',
    label: 'Specialists',
    description: 'Strategy leaders, data engineers, analysts, and enablement experts delivering end-to-end programmes.'
  },
  {
    value: '22',
    label: 'Markets served',
    description: 'Follow-the-sun delivery with teams across North America, Europe, Asia Pacific, and the Middle East.'
  },
  {
    value: '96%',
    label: 'Client retention',
    description: 'Multi-year partnerships anchored on transparency, measurable outcomes, and accountable governance.'
  }
]
...
const pillars = [
  {
    ...
    description: 'Global experience aligning boards, business units, and technology teams around ambitious, achievable data strategies.',
    bullets: [
  ...
  },
  {
    ...
    description: 'Modern cloud platforms, pipelines, and analytics products built with resilience, lineage, and observability from day one.',
    bullets: [
  ...
  },
  {
    ...
    description: 'Embedding insights into business processes through enablement, communications, and lifecycle partnerships.',
    bullets: [
...
const milestones = [
  {
    ...
    description: 'Founded by practitioners who previously scaled data and analytics inside Fortune 100 and high-growth technology firms.'
  },
  {
    year: '2019',
    title: 'Cloud delivery accelerators launched',
    description: 'Released reusable ingestion, transformation, and governance frameworks to shorten value realisation without sacrificing control.'
  },
  {
    year: '2021',
    title: 'Global delivery hubs established',
    description: 'Opened centres in London, Toronto, Singapore, and Austin to support regional expertise with round-the-clock execution.'
  },
  {
    year: '2023',
    title: 'Responsible AI practice introduced',
    description: 'Brought together data science, risk, and architecture leaders to design measurable, production-ready AI programmes.'
  }
]
...
const teamScenes = [
  {
    ...
    caption: 'Programme directors, architects, and analysts planning cross-discipline releases with client PMOs.'
  },
  {
    image: '/brand/christina-wocintechchat-com-faEfWCdOKIg-unsplash.jpg',
    label: 'Enablement sessions',
    caption: 'Designers and adoption leads co-creating analytics journeys and communications with business stakeholders.'
  }
]
  ...
  return (
    <main id="content">
      <section className="relative isolate overflow-hidden pb-24 pt-32 sm:pt-36">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(120%_90%_at_20%_15%,rgba(255,63,46,0.25),transparent_55%)]" aria-hidden />
        <div className="absolute inset-0 bg-[radial-gradient(110%_80%_at_80%_20%,rgba(255,111,60,0.2),transparent_60%)]" aria-hidden />
            ...
            <div className="space-y-10 text-white">
              ...
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-base text-white/75 sm:text-lg">
                  Arctura Analytics partners with enterprises to plan, build, and operate modern data capabilities. We combine advisory, engineering, and enablement so that strategy connects seamlessly to delivery and adoption.
                </p>
              </div>
              <div className="grid gap-5 sm:grid-cols-3">
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <div className="mt-1 text-xs uppercase tracking-[0.28em] text-white/60">{stat.label}</div>
      ...
      <Section className="relative overflow-hidden py-24">
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/2 top-16 h-[420px] w-[85%] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,63,46,0.14),transparent_70%)] blur-[160px]" aria-hidden />
        </div>
        <Container className="relative">
          <div className="mx-auto mb-16 max-w-3xl text-center text-white">
            ...
            <h2 className="mt-6 text-3xl font-black sm:text-4xl md:text-5xl">Integrated capability across advisory, delivery, and change</h2>
            <p className="mt-4 text-base text-white/75 sm:text-lg">
              We align strategy, execution, and adoption for the organisations we serve. Every engagement is staffed with practitioners who care about measurable impact and sustainable platforms.
            </p>
          </div>
      ...
      <Section className="relative overflow-hidden py-24">
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-[12%] top-10 h-64 w-64 rounded-full bg-[radial-gradient(circle,rgba(255,63,46,0.2),transparent_70%)] blur-[140px]" aria-hidden />
          <div className="absolute right-[10%] bottom-0 h-80 w-80 rounded-full bg-[radial-gradient(circle,rgba(255,111,60,0.18),transparent_75%)] blur-[160px]" aria-hidden />
        </div>
        <Container className="relative">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <h2 className="mt-6 text-3xl font-black text-white sm:text-4xl">Proven growth through continuous investment in capability</h2>
              <p className="mt-4 max-w-xl text-base text-white/75 sm:text-lg">
                Our journey has been guided by the needs of data leaders. Each milestone reflects a new layer of accelerators, governance, and talent developed with clients.
              </p>
              <div className="mt-12 space-y-10 border-l border-white/12 pl-8">
                {milestones.map((milestone, index) => (
                  ...
                  >
                    ...
                    <div className="text-xs uppercase tracking-[0.28em] text-white/60">{milestone.year}</div>
            ...
            <div className="grid gap-6">
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-x-6 bottom-6 text-white">
                  <p className="text-sm text-white/75">
                    Integrated squads bring architecture, engineering, analytics, and change to every programme, ensuring momentum from discovery through hypercare.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="mt-3 text-sm text-white/75">
                  Every engagement follows a disciplined cadence built on discovery, design, delivery, and steady-state enablement. Clients stay informed and in control at each stage.
                </p>
      ...
      <Section className="relative overflow-hidden py-24">
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-x-0 top-[18%] h-48 bg-[radial-gradient(70%_150%_at_50%_0%,rgba(255,111,60,0.16),transparent_70%)]" aria-hidden />
        </div>
        <Container className="relative">
          <div className="mx-auto max-w-5xl text-center text-white">
            ...
            <h2 className="mt-6 text-3xl font-black sm:text-4xl">What to expect when we deliver together</h2>
            <p className="mt-4 text-base text-white/75 sm:text-lg">
              Complex programmes demand clarity, accountability, and care. Our teams operate as an extension of yours, bringing proven methods and open communication.
            </p>
          </div>
          ...
          >
            <h3 className="text-2xl font-semibold text-white md:text-3xl">Ready to discuss your next data initiative?</h3>
            <p className="mt-4 max-w-2xl text-sm text-white/75 sm:text-base">
              Share your objectives and constraints. We will assemble the right advisory and delivery squad to move quickly while protecting quality and governance.
            </p>
            <a
